...
public class GameModel : Model
{
    ...
    public bool DayEndCheck()
    {
        switch (Day)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                if (day3_ReporterWang && day3_RedRecord)
                {
                    if (!guide11)
                    {
    ...
    public void Reset()
    {
        ...
        day3_Piece4 = false;
        day3_Piece5 = false;
        day3_LoginEmail = false;
        day3_RedRecord = false;
        day3_ReporterWang = false;
            ...
            case 3:
                switch (targetName)
                {
                    case "EnergyRepair1":
                        ...
                        {
                            SendEvent(Const.E_ShowMessage, "tips20");
                            return false;
                        }
